...
export default function page() {
  ...
  const articlesHeading = {
    title: 'Articles',
    description: 'Here are some articles that are very important for your safety. Please read the articles and learn the important things.',
  }
  ...
  const articlesLists = [
    {
      ...
      description: 'Construction safety week is a very important safety measure for crane operators. It is a safety measure that is used to protect the crane operator from the crane lift zone.',
  ...
  const FAQLists = [
    {
      ...
      answer: 'Safety is a very important safety measure for crane operators. It is a safety measure that is used to protect the crane operator from the crane lift zone.',
    },
    {
      question: 'What is safety?',
      answer: 'Safety is a very important safety measure for crane operators. It is a safety measure that is used to protect the crane operator from the crane lift zone.',
  ...
  const FAQHeading = {
    title: 'FAQ',
    description: 'Here are some frequently asked questions about safety. Please read the frequently asked questions and learn the important things.',
  }
  ...
  return (
    <div className="flex flex-col gap-5 mt-10 md:mt-16">
      ...
      <ArticlesCards articles={articlesLists} title={articlesHeading.title} description={articlesHeading.description}/>
