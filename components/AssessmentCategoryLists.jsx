                  ...
                  >
                    <div className="relative aspect-[16/10] w-full overflow-hidden bg-gradient-to-br from-[color:var(--hover-bg)] to-[color:var(--bg-section)]">
                      {imageSrc ? (
                        <>
                          <Image
                            src={imageSrc}
                            alt={t?.title ? `${t.title} preview` : `${cat.title} test`}
                            fill
                        ...
                        <div
                          ...
                          aria-hidden="true"
                        >
                          <span className="text-sm text-[color:var(--text-muted)]">Image</span>
                        </div>
                      )}
                    ...
                    <div className="flex flex-1 flex-col p-5">
                      ...
                      {t?.description ? (
                        ...
                        <p className="mt-2 flex-1 text-sm text-[color:var(--text-secondary)]">Knowledge check</p>
                      )}

                      <div className="mt-5 flex items-center justify-between gap-3 border-t border-[color:var(--border-light)] pt-4">
                        <span className="text-xs font-medium text-[color:var(--text-muted)]">{cat.title}</span>
        ...
        >
          ...
          <div className="relative w-full max-w-md overflow-hidden rounded-3xl border border-[color:var(--border-light)] bg-[color:var(--bg-card)] shadow-[0_24px_60px_-12px_rgba(0,0,0,0.25)]">
            ...
            <div className="p-6 sm:p-8">
              ...
              <p className="mt-2 text-base font-medium text-[color:var(--text-primary)]">“{confirmTest.title}”</p>
              <p className="mt-4 text-sm leading-relaxed text-[color:var(--text-secondary)]">
                You’ll move through a short set of questions. Your score appears when you finish — take your time on
                each one.
              </p>
