    ...
    const topics = [
        {
            ...
            image: '/explore/emotional-intelligence.jpg',
            whatYouWillLearn: [
                'Human behavior',
                'Social interaction',
               "Emotional control",
      ...
      <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
        {topics.map((topic) => (
          <Link
            ...
            className="block focus:outline-none focus-visible:ring-2 focus-visible:ring-gray-900/40 focus-visible:ring-offset-2"
          >
            <article className="group cursor-pointer overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-sm transition hover:-translate-y-0.5 hover:shadow-md">
